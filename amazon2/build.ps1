...
<#
    ...
    PS> build.ps1 -VCServer vcenter.local -ClusterName ESX_Cluster -DatastoreName Storage1 -Network Name VM_Network
...
param(
    ...
    [String] $NetworkName="",
    [string] $VCAdminUser="",
    [String] $VMName="vm-amazon2",
    [String] $DiskFormat="Thin",
    [String] $Folder="Templates",
    [String] $SourceContentLibrary="",
    [String] $TargetContentLibrary="",
    [String] $SourceOva="amazon2",
    [String] $TargetOva="amazon2-ova",
